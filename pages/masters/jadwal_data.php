				  ...
				  <fieldset> 
					<table class="table table-striped"> 
						<?php 
							...
							buatInputText($isian[10],10,$data[10]); 
							buatInputText($isian[11],11,$data[11]); 
							buatInputText($isian[12],12,$data[12]); 
							buatInputText($isian[13],13,$data[13]); 
							buatInputText($isian[14],14,$data[14]); 
							buatInputText($isian[15],15,$data[15]); 
							buatInputText($isian[16],16,$data[16]); 
