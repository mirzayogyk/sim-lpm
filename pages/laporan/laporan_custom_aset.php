...
if(($ruangan=='')&&($kondisi=='')) { 
 $pageSql = "SELECT $tableName.id_barang,$tableName.kode_barang,$tableName.nama_barang,$tableName.tahun_pengadaan, $tableName.jenis_aset,$tableName.id_ruangan,$tableName.id_kondisi,truangan.nama_ruangan,tkondisi.kondisi,tkondisi.keterangan FROM ".$tableName." LEFT JOIN truangan ON truangan.id_ruangan=$tableName.id_ruangan LEFT JOIN tkondisi ON tkondisi.id_kondisi=$tableName.id_kondisi WHERE jenis_aset='Aset' AND $tableName.tahun_pengadaan='$tahun'";
	
} else if($kondisi==''){
 $pageSql = "SELECT $tableName.id_barang,$tableName.kode_barang,$tableName.nama_barang,$tableName.tahun_pengadaan, $tableName.jenis_aset,$tableName.id_ruangan,$tableName.id_kondisi,truangan.nama_ruangan,tkondisi.kondisi,tkondisi.keterangan FROM ".$tableName." LEFT JOIN truangan ON truangan.id_ruangan=$tableName.id_ruangan LEFT JOIN tkondisi ON tkondisi.id_kondisi=$tableName.id_kondisi WHERE jenis_aset='Aset' AND $tableName.tahun_pengadaan='$tahun'   AND $tableName.id_ruangan='$ruangan' ";
 
}  else if($ruangan==''){
 $pageSql = "SELECT $tableName.id_barang,$tableName.kode_barang,$tableName.nama_barang,$tableName.tahun_pengadaan, $tableName.jenis_aset,$tableName.id_ruangan,$tableName.id_kondisi,truangan.nama_ruangan,tkondisi.kondisi,tkondisi.keterangan FROM ".$tableName." LEFT JOIN truangan ON truangan.id_ruangan=$tableName.id_ruangan LEFT JOIN tkondisi ON tkondisi.id_kondisi=$tableName.id_kondisi WHERE jenis_aset='Aset' AND $tableName.tahun_pengadaan='$tahun' AND $tableName.id_kondisi=$kondisi ";
