...
if($_GET) {
	if(isset($_POST['btnSave'])){
		...
		if(mysqli_num_rows($cekQry)>=1){
			$pesanError[] = "Maaf, ".$isian1." <b> $txt1 </b> ".$isian3." <b> $txt3 </b>  sudah kami terima, Silakan tunggu pesan anda kami verifikasi.";
		}		
		...
		if (count($pesanError)>=1 ){
			...
			if($myQry){
				echo "<meta http-equiv='refresh' content='0; url=?page=".$formName."-User'>";
			}
			exit;
		}
	} // Penutup POST
...
<table class="table  table-striped">
  <tr>
	...
	<form class="navbar-search pull-right"  method="POST" action="?page=<?php echo $formName?>-User">
  ...
  <div class="accordion" id="collapse-group">
                            ...
                            <div class="accordion-group widget-box">
                                ...
                                <div class="collapse accordion-body" id="collapseGTwo">
                                    <div class="widget-content">
									   ...
									   <form id="new-project" class="form-horizontal " action="?page=<?php echo $formName;?>-User" method="post" name="form1" target="_self">
						<fieldset>
						<table class="table table-striped">
    ...
    <tr>
      ...
      <td width="2%"><b>:</b></td>
      <td width="74%"><input name="txt1" type="text" class="input-xlarge" value="<?php echo $_SESSION['NGARAN_SHARPSHOOT3R']; ?>" size="60" maxlength="60"   readonly />
	</td>
	...
	<tr>
      ...
      <td>
		...
		<input name="txt3" type="email" class="input-xlarge" value="<?php echo $_SESSION['NGINX_NYA'] ; ?>" size="60" maxlength="60"  readonly />  
		  </td>
