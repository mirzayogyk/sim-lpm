...
include_once "barang_config.php"; 
if($_GET) { 
		  ...
		  <div class="widget-content">      
			  <form id="new-project" class="form-horizontal " action="?page=<?php echo $formName;?>-Data" method="post" name="form1" target="_self"> 
				  <fieldset> 
					<table class="table table-striped"> 
						<tr> 
							<td width="24%"><b><?php echo $isian[1]; ?></b></td>  
							<td width="2%"><b>:</b></td>  
							<td width="74%"><input name="txt1" type="text" class="input-xxlarge" value="<?php echo $data[1]; ?>" size="60" maxlength="60"  /></td>  
						</tr> 
						<tr> 
							<td width="24%"><b><?php echo $isian[2]; ?></b></td>  
							<td width="2%"><b>:</b></td>  
							<td width="74%"><input name="txt2" type="text" class="input-xxlarge" value="<?php echo $data[2]; ?>" size="60" maxlength="60"  /></td>  
						</tr> 
						<tr> 
...
<table class="table table-bordered table-striped"> 
	<tr> 
		...
		<th><strong><?php echo $isian[1]; ?></strong></th> 
		<th><strong><?php echo $isian[2]; ?></strong></th> 
