...
<fieldset> 
	<legend>Ubah <?php echo $formName?></legend> 
		...
		<div class="control-group"> 
			<label class="control-label" for="input01"><?php echo $isian[1]; ?></label>  
			<div class="controls">  
				<input name="txt1" type="text" class="input-xlarge" id="input01" value="<?php echo $data[1]; ?>"  size="60" maxlength="50" />  
			</div> 
		</div> 
		<div class="control-group"> 
			<label class="control-label" for="input02"><?php echo $isian[2]; ?></label>  
			<div class="controls">  
				<input name="txt2" type="text" class="input-xlarge" id="input02" value="<?php echo $data[2]; ?>"  size="60" maxlength="50" />  
			</div> 
		</div> 
		<div class="control-group"> 
